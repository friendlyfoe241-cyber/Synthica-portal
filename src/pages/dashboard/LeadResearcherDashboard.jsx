  ...
  return (
    <DashboardShell activeTab="dashboard">
      <div className="db-page">
        ...
        <div style={{ marginBottom: '1.5rem', display: 'flex', justifyContent: 'flex-end', gap: '0.75rem' }}>
          <a 
            href={`/LeadResearchCertGen/generator.html?name=${encodeURIComponent(userProfile?.full_name || user?.user_metadata?.full_name || '')}`}
            target="_blank"
